		...
		<div class="col-md-12">
			...
			<div class="tabbable" id="tabs-963848">
				<ul class="nav nav-tabs">
					...
					<li class="active">
						<a href="#panel-354701" data-toggle="tab">Restauracion</a>
					</li>
				</ul>
				...
				<tbody>
					...
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						<tr>
							...
							<td>
								<a href="restauracion.php?id=<?php echo $row['id'];?>"><img src="imagenes/restauracion.png"></a>
							</td>
						</tr>
					<?php } ?>
				</tbody>
